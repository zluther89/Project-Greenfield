...
class WriteNewReview extends React.Component {
  ...
  GetCharacterstics() {
    ...
    Axios.get(
      `http://3.134.102.30/reviews/${productId}/meta`
    )
      .then(response => {
  ...
  handleCharacteristic(e) {
    ...
    const AllCharacteristics = {
      "Size": { 1: "A size too small", 2: "1/2a size too small", 3: "Perfect", 4: "1/2 a size too big", 5: "A size too wide" },
    ...
    this.setState({[characteristic]:AllCharacteristics[ characteristic ][select]})
  }
